...
console.log(" Equality Test",("Rabia Rehman" as string) === "Rabia Rehman");
//test for Inequality
console.log(" Inequality Test",("Rabia Rehman" as string) == "Rabia Rani");

//test using the lower case function
console.log("lower case test",("ABDUL REHMAN" as string).toLowerCase() === "abdul rehman");
...
console.log("In quality Test",(10 as number) == 9);
